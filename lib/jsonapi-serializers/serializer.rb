...
module JSONAPI
  module Serializer
    ...
    def self.serialize(objects, options = {})
      ...
      if includes
        ...
        objects.compact.each do |obj|
          ...
          find_recursive_relationships(obj, inclusion_tree, relationship_data, passthrough_options[:serializer].new(obj))
        end
    ...
    # }
    def self.find_recursive_relationships(root_object, root_inclusion_tree, results, serializer = nil)
